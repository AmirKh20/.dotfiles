...
local pacupdates = awful.widget.watch('bash -c "checkupdates | wc -l"', 90, function(widget, stdout) -- every 90 seconds it checks for updates
    widget:set_markup(markup.fontfg(theme.font, "#50FA7B", "" .. stdout .. " "))
end)
local aurupdates = awful.widget.watch('bash -c "checkupdates-aur | wc -l"', 90, function(widget, stdout) -- every 90 seconds it checks for updates
    widget:set_markup(markup.fontfg(theme.font, "#50FA7B", "+" .. stdout .. " "))
end)
   ...
   s.quake = lain.util.quake({ app = "st", height = 0.50, argname = "-e %s" })
    ...
    s.mywibox:setup {
        ...
        { -- Left widgets
            ...
            --spr,
            wibox.widget.imagebox(theme.awesome_icon),
            s.mytaglist,
            s.mypromptbox,
            spr,
        },
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            ...
            arrow("alpha", "#8b0000"),
            wibox.container.background(wibox.container.margin(wibox.widget { pacicon, pacupdates, aurupdates,stdout ,layout = wibox.layout.align.horizontal }, 2, 3), "#8b0000"),
            arrow("#8b0000", "#00008b"),
            wibox.container.background(mykeyboardlayout,"#00008b"),
            arrow("#00008b", "#8b0000"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#8b0000"),
            arrow("#8b0000", "#00008b"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#00008b"),
            arrow("#00008b", "#8b0000"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, 3, 4), "#8b0000"),
            arrow("#8b0000", "#00008b"),
            wibox.container.background(wibox.container.margin(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, 4, 4), "#00008b"),
            --arrow("#00008b", "#8b0000"),
            --wibox.container.background(wibox.container.margin(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#8b0000"),
            arrow("#00008b", "#8b0000"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#8b0000"),
            arrow("#8b0000", "#00008b"),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#00008b"),
            arrow("#00008b", "#8b0000"),
            wibox.container.background(wibox.container.margin(clock, 4, 8), "#8b0000"),
            arrow("#8b0000", "alpha"),
            --]]
