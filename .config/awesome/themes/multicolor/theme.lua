...
local mytextclock = wibox.widget.textclock(markup("#7788af", "%A %d %B ") .. markup("#ff0000", "/") .. markup("#de5e1e", " %H:%M "))
...
function theme.at_screen_connect(s)
   ...
   s.quake = lain.util.quake({ app = "alacritty", height = 0.50, argname = "-e %s" })
